...
Fornecedor
	- email; NIF; nome
	- tipo de fornecedor (atributo multivalor)
		> designação; código
	- condiçoes de pagamento (atributo multivalor)
		> designação; código
...
```
N Produtos <--> 1 Taxa IVA
N Produtos <--> 1 Empresa
N Produtos <--> 1 Armazem
N Produtos <--> M Encomendas
1 Encomenda <--> N Fornecedor
N Fornecedor <--> 1 Tipo de Fornecedor
N Fornecedor <--> 1 Condição de Pagamento
