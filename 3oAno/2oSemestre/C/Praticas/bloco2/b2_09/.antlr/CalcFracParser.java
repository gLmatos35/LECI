...
public class CalcFracParser extends Parser {
	...
	public static class MainContext extends ParserRuleContext {
		...
		public List<TerminalNode> NL() { return getTokens(CalcFracParser.NL); }
		public TerminalNode NL(int i) {
			return getToken(CalcFracParser.NL, i);
		}
	...
	public final MainContext main() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 96708L) != 0)) {
				{
				setState(18);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public static class FracContext extends ExprContext {
		...
		public TerminalNode NUM() { return getToken(CalcFracParser.NUM, 0); }
